...
from models import User, Account, Wallet, Farm, Partner, Task, Reward, RefferAccount, Add, Activity, DailyActivity, New
...
def create_admin(app):
    ...
    [admin.add_view(create_view(model)) for model in [User, Account, Wallet, Farm, Reward, RefferAccount, Add, Activity, DailyActivity, New]]
